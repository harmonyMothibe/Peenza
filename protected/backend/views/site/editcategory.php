...
<h2><b>How to...</b></h2>
<p><b>Category Title</b> - Add a <i><b>Category Name</b></i> by typing into the field. The <i><b>Category Title</b></i> set here becomes the title of the category shown on the public view.</p>
...
<p><b>Images</b> - Use the <i><b>Insert/Edit Image</b></i> icon (<img src="<?= Yii::app()->request->baseUrl; ?>/images/icons/img.png">) to upload images. Once you open the <i><b>Insert/Edit Image</b></i> dialog, click on the small browse icon just to the right of the <i><b>Image Url</b></i> field. This will allow you to upload and manage more images.</p>
	...
	<h3>Edit Category</h3>
<div class="form">
	<form name="Editcategory" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/backend.php/site/updatecategory/id/<?= $_GET['id'];?>" id="categories">
			<table cellspacing="0" cellpadding="0" style="border: none; width: 650px; margin-bottom: 0px;">
					...
					<tr>
						...
						<td>
							<?= CHtml::textField('category_name', $data['category_name'], array('style' => 'width: 200px;', 'id' => 'category_name')); ?>
						</td>
					</tr>
					<tr>
						<td colspan="2" valign="top">
							<br />
							<?= CHtml::textArea('description', $data['description'], array('style' => 'width: 600px; height: 400px;', 'id' => 'description')); ?>
						</td>
					</tr>
				</table>
				<br />
