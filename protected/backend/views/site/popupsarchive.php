...
<div id="section_heading">Popups Archives</div>
<div id="search" style="width: 800px;">
	<form name="search" action="<?php echo Yii::app()->request->baseUrl; ?>/backend.php/site/popupsarchive/scenario/search" method="post" style="float: right;">
	...
	'columns'=>array(
		...
		array(
			...
			(
				...
				(
					'label'=>'view',
					'url'=>'Yii::app()->createUrl("site/viewpopuparchive", array("id"=>$data->id))',
					'options'=>array('id'=>'button')
				),
				'delete_post'=>array
				(
					'label'=>'delete',
					'url'=>'Yii::app()->createUrl("site/deletepopup", array("id"=>$data->id))',
