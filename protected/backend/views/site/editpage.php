...
<h2><b>How to...</b></h2>
<p><b>Page Title</b> - Add a <i><b>Page Title</b></i> by typing into the field. The <i><b>Page Title</b></i> set here becomes the title of the page shown on the public view.</p>
<p><b>Editor</b> - Use the WYSIWYG (What You See Is What You Get) Editor to add content to your page. Use the familiar toolbar icons to format our text accordingly.</p>
<p><b>Images</b> - Use the <i><b>Insert/Edit Image</b></i> icon (<img src="<?= Yii::app()->request->baseUrl; ?>/images/icons/img.png">) to upload images. Once you open the <i><b>Insert/Edit Image</b></i> dialog, click on the small browse icon just to the right of the <i><b>Image Url</b></i> field. This will allow you to upload and manage more images.</p>
	...
	<h3>Edit Page</h3>
<div class="form">
	<form name="Editpage" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/backend.php/site/updatepage/id/<?= $_GET['id'];?>" id="pages">
			<table cellspacing="0" cellpadding="0" style="border: none; width: 650px; margin-bottom: 0px;">
					...
					<tr>
						<td>
							<label for="title">Page Title: <span class="asterisks">*</span></label>
						</td>
						<td>
					...
					<tr>
						<td colspan="2" valign="top">
							<br />
							<?= CHtml::textArea('page_details', $data['details'], array('style' => 'width: 600px; height: 400px;', 'id' => 'page_details')); ?>
						</td>
					</tr>
				</table>
				<br />
