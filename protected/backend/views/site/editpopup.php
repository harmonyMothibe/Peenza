...
<h2><b>How to...</b></h2>
<p><b>Popup Title</b> - Add a <i><b>Popup Title</b></i> by typing into the field. The <i><b>Popup Title</b></i> set here becomes the title of the popup shown on the public view.</p>
<p><b>Editor</b> - Use the WYSIWYG (What You See Is What You Get) Editor to add content to your popup. Use the familiar toolbar icons to format our text accordingly.</p>
<p><b>Images</b> - Use the <i><b>Insert/Edit Image</b></i> icon (<img src="<?= Yii::app()->request->baseUrl; ?>/images/icons/img.png">) to upload images. Once you open the <i><b>Insert/Edit Image</b></i> dialog, click on the small browse icon just to the right of the <i><b>Image Url</b></i> field. This will allow you to upload and manage more images.</p>
	...
	<h3>Edit Popup</h3>
<div class="form">
	<form name="Editpopup" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/backend.php/site/updatepopup/id/<?= $_GET['id'];?>" id="popups">
			<table cellspacing="0" cellpadding="0" style="border: none; width: 650px; margin-bottom: 0px;">
					...
					<tr>
						<td>
							<label for="title">Popup Title: <span class="asterisks">*</span></label>
						</td>
						<td>
					...
					<tr>
						<td>
							<label for="title">Popup Url: </label>
						</td>
						<td>
							http://<?= $_SERVER['HTTP_HOST'];?><?= Yii::app()->request->baseUrl;?>/index.php/site/content/id/<?= $data['id']; ?>
						</td>
					</tr>
					<tr>
						<td colspan="2" valign="top">
							<br />
							<?= CHtml::textArea('popup_details', $data['details'], array('style' => 'width: 600px; height: 400px;', 'id' => 'popup_details')); ?>
						</td>
					</tr>
				</table>
				<br />
