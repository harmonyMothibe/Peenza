...
<div id="section_heading">Add Administrator</div><br /><br />
...
<div class="form">
	<form name="Administrator" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/backend.php/administrators/create" id="administrator">
		<table cellspacing="0" cellpadding="0" style="border: none; width: 600px; margin-bottom: 0px;" class="buyers">
			<tr>
				...
				<td style="width: 100px; border: none;">
					<?= CHTML::textField('first_name', '', array('id' => 'first_name')); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 30%; border: none;">
				...
				<td style="width: 100px; border: none;">
					<?= CHTML::textField('last_name', '', array('id' => 'last_name')); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 30%; border: none;">
				...
				<td style="width: 100px; border: none;">
					...
					<?= CHTML::textField('email', '', array('id' => 'email', 'onblur' => 'check_email(this.value, "'.Yii::app()->request->baseUrl.'/backend.php/site/validate_email")')); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 30%; border: none;">
				...
				<td style="width: 100px; border: none;">
					<?= CHTML::textField('tel', '', array('id' => 'tel')); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 30%; border: none;">
				...
				<td style="width: 100px; border: none;">
					...
					<?= CHTML::textField('username', '', array('id' => 'username', 'onblur' => 'check_username(this.value, "'.Yii::app()->request->baseUrl.'/backend.php/site/validate_username")')); ?>
				</td>
			</tr>
			<tr>
				<td style="width: 30%; border: none;">
					<label>Password: <span class="asterisks">*</span></label>
				</td>
				<td style="width: 100px; border: none;">
			...
			<tr>
				<td style="width: 30%; border: none;">
					<label>Confirm Password: <span class="asterisks">*</span></label>
				</td>
				<td style="width: 100px; border: none;">
