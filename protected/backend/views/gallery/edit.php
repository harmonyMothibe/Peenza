...
<div id="section_heading" style="margin-bottom: 5px;">Edit Album</div><br /><br />
	<div class="form">
		<form name="AddMenu" method="post" action="<?php echo Yii::app()->request->baseUrl; ?>/backend.php/gallery/update/id/<?= $_GET['id'];?>" id="albums">
