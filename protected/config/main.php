		...
		*/
		...
		//Localhost
			...
			'charset' => 'utf8',
                ...
                // Local server
               /* 'db'=>array(
			'connectionString' => 'mysql:host=10.0.108;dbname=peenza_main',
			'emulatePrepare' => true,
			'username' => 'developer',
			'password' => 'password',
			'charset' => 'utf8',
                ...
                // ctsc
		/*'db'=>array(
			'connectionString' => 'mysql:host=ctsc.co.za;dbname=ctsccsuu_main',
			'emulatePrepare' => true,
			'username' => 'ctsccsuu_root',
			'password' => 'Custom!zed9',
			'charset' => 'utf8',
		),*/
                // Peenza
                /*'db'=>array(
