...
class Pages extends CActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('location, remuneration', 'length', 'max'=>255),
            // The following rule is used by search().
            // Please remove those attributes that should not be searched.
            array('id, active, location, title, application_date, remuneration, details, created_date', 'safe', 'on'=>'search'),
        );
    }
    ...
    public function search()
    {
        ...
        $criteria->compare('remuneration',$this->remuneration,true);
